...
from uni_splice.g2p import IG2P


class SoundChoiceG2P(IG2P):
    ...
    def __init__(self, root, modules, device=None):
        config = f"{root}/hyperparams.yaml"
        model_state = f"{root}/model.ckpt"
        ctc_lin_state = f"{root}/ctc_lin.ckpt"
...
#     hparams_file = "/mnt/lustre/sjtu/home/ww089/speechbrains/speechbrain/recipes/LibriSpeech/G2P/results/finetune/libri_g2p/100h/RNN/1111/save/pretrained_models/hyperparams.yaml"
#     model_state = "/mnt/lustre/sjtu/home/ww089/speechbrains/speechbrain/recipes/LibriSpeech/G2P/results/finetune/libri_g2p/100h/RNN/1111/save/pretrained_models/model.ckpt"
#     ctc_lin_state = "/mnt/lustre/sjtu/home/ww089/speechbrains/speechbrain/recipes/LibriSpeech/G2P/results/finetune/libri_g2p/100h/RNN/1111/save/pretrained_models/ctc_lin.ckpt"
    root = "/mnt/lustre/sjtu/home/ww089/speechbrains/speechbrain/recipes/LibriSpeech/G2P/results/finetune/english_g2h_km_L7_500/RNN_large/1111/save/pretrained_models"

    # Run the evaluation
    g2p = SoundChoiceG2P(
        hparams_file, {"model": model_state, "ctc_lin": ctc_lin_state}
    )
    print(g2p("this is a test"))
